<?php /* Smarty version Smarty-3.1.18, created on 2014-09-08 16:35:05
         compiled from "C:\AppServ\www\projectSpa\backoffice\template\form_withdraws.html" */ ?>
<?php /*%%SmartyHeaderCode:26378540d6a39cb57c3-39229483%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '26378540d6a39cb57c3-39229483',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_540d6a39df7247_00368559',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_540d6a39df7247_00368559')) {function content_540d6a39df7247_00368559($_smarty_tpl) {?><!DOCTYPE html>
<html lang="th">
<head>
	    ...
	    <tbody>
            <tr>
                <td>
                    ...
                    <div id="emp_give_id" class="select-reference form-input half" > </div>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <label class="input-required">วันที่เบิกผลิตภัณฑ์</label>
                      <input id="wdw_date" name="wdw_date" type="text" class="form-input half" value="<?php echo $_smarty_tpl->tpl_vars['values']->value['wdw_date'];?>
">
                </td>
               <td>
