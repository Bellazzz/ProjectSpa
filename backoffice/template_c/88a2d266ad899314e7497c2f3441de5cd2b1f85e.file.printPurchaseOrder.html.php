...
<div class="ftb-header">
	<div class="title-container">
		<h1 id="ftb-title">พิมพ์ใบสั่งซื้อ</h1>
	</div>
...
?>
	            <tr>
	                ...
	                <td align="center"><?php echo $_smarty_tpl->tpl_vars['orddlt']->value['prd_name'];?>
</td>
	                <td align="right"><?php echo $_smarty_tpl->tpl_vars['orddlt']->value['orddtl_amount'];?>
</td>
	                <td align="center"><?php echo $_smarty_tpl->tpl_vars['orddlt']->value['unit_name'];?>
</td>
...
?>
    ...
    <div style="text-align: center;">
    	<div class="signature">
    		...
    		<p align="center">(<?php echo $_smarty_tpl->tpl_vars['ordData']->value['emp_fullname'];?>
)</p>
