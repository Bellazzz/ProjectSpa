<?php /* Smarty version Smarty-3.1.18, created on 2014-10-01 18:02:19
         compiled from "C:\AppServ\www\projectSpa\backoffice\template\printPurchaseOrder.html" */ ?>
<?php /*%%SmartyHeaderCode:8499542baabdaa1938-19737391%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '8499542baabdaa1938-19737391',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_542baabde86ad4_29050495',
  'variables' => 
  array (
    'ordData' => 0,
    'spaData' => 0,
...
<?php if ($_valid && !is_callable('content_542baabde86ad4_29050495')) {function content_542baabde86ad4_29050495($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
	...
	<script>
		...
		function confirmPrint() {
			parent.showActionDialog({
                ...
                message: 'ใบสั่งซื้อนี้ถูกพิมพ์ไปแล้ว X ครั้ง ท่านต้องการพิมพ์อีกใช่หรือไม่?',
                actionList: [
                    {
                        id: 'ok',
                        name: 'ตกลง',
                        ...
                        func:
                        function() {
                        	// Save print purchase when success will call printPurchaseOrder()
                        	printPurchaseOrder();
