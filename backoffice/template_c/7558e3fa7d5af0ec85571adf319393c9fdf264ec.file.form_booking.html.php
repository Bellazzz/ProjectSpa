...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2152153fc7fa0a9fbf4-12438904',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_53fc7fa0bdc167_26470959',
  'variables' => 
  array (
    'action' => 0,
    'tableName' => 0,
...
<?php if ($_valid && !is_callable('content_53fc7fa0bdc167_26470959')) {function content_53fc7fa0bdc167_26470959($_smarty_tpl) {?><!DOCTYPE html>
<html lang="th">
<head>
...
<div class="ftb-body">
	...
	<input type="hidden" name="requiredFields" value="cus_id,emp_id,status_id,bnkacc_id,bkg_total_price,bkg_date">
...
">
                ...
                <td>
                    ...
                    <input id="bkg_transfer_evidence" name="bkg_transfer_evidence" type="text" class="form-input half" value="<?php echo $_smarty_tpl->tpl_vars['values']->value['bkg_transfer_evidence'];?>
">
                </td>
            </tr>
             <tr>
                <td>
                    <label class="input-required">ราคารวมการจองทั้งหมด(บาท)</label>
...
">
                ...
                <td>
                    <label class="input-required">วัน-เวลาที่จอง</label>
